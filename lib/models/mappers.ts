...
export const ENTITIES = {
  trips: makeMapper<Trip>([["id","s"],["name","s"],["destination","s"],["start_date","s"],["end_date","s"],["home_currency","s"],["trip_currency","s"],["status","s"],["cover_photo_id","s"],["home_timezone","s"],["trip_timezone","s"]]),
  ...
  members: makeMapper<Member>([["id","s"],["trip_id","s"],["name","s"],["color","s"],["promptpay_id","s"]]),
